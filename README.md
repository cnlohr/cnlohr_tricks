...
8. Is there something the compiler doesn't understand how to optimize about your problem.  If so, you can sometimes resole this with asm volatile. (See [my Hackaday 2022 talk](https://www.youtube.com/watch?v=Gelf0AyVGy4) or [my page on assembly optimization in C](https://github.com/cnlohr/assembly-notes))
...
THIS SECTION OF TEXT IS COPIED FROM that website, wholesale.  If there is any issue with this, please reach out to me and I will remove it from here but it is was of such importance I felt it was crucial not to be lost.

Sinetable Calculation v1.1, Sinustable calculations by Azure
